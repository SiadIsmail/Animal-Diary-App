...
public class Pet : INotifyPropertyChanged, ISyncable
{
    ...
    /// <summary>
    /// This pet and everything hanging off it is <b>seeded demo data</b>, not a record of
    /// a real animal. Set once at seeding and never again.
    ///
    ...
    ///
    /// <para>Deliberately NOT part of <see cref="ISyncable"/>: it is a local-only fact about
    /// where a row came from, it is never sent, and a pet arriving from the cloud is by
    /// definition not demo.</para>
    /// </summary>
