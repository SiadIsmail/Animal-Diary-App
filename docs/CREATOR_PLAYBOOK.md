...
## 1. Turn on the demo pets

1. Open **Settings → Code**.
2. Type the code you were given and tap **Unlock**.
3. Tap **Add demo pets**.

You now have **Kira** and **Mira**, each with a year of history, in whatever language the
app is set to. Kira is active; switch between them on the **Pets** tab.

To remove them afterwards: same place, **Remove demo pets**. That deletes them and
everything they recorded, and cancels their reminders.

**Set the app's language before you seed.** Medication names and food labels are stored
the way an owner would have typed them, so they don't re-translate afterwards. To switch
languages, remove the demo pets, change the language, and add them again.
...
| Medication | Phenobarbital 2×/day, potassium bromide evenings | Insulin 2×/day, mirtazapine 3 days/week |
| Records | Seizures, mood, weight, appetite, walks | Glucose, water, appetite, mood, weight, sick days |
...
Open Kira, then **Pets → Quick management → Constellation**.

**1. Timeline, 365 days.** The whole year as one sky. This is the shot people share.
...
the most persuasive thing in the app. Works on the 30-day range you're already on.

**4. Nights, 90 days.** One day per row, oldest at the top. The small-hours habit is a
...
- **Felova records; it never judges.** No score, no streak, no "you missed 3 doses".
...
- Kira's and Mira's reminders will fire on your phone while they exist. That's on
  purpose if you want to film a notification arriving; removing the demo pets stops them.
- The same code always produces the same history, so you can re-shoot a take tomorrow
  and everything will be exactly where it was.
- Demo pets are never backed up or synced, even if you're signed in, and signing out
  won't remove them.
